...
replace github.com/seanrmurphy/ws-echo/backend/lambda/types => ../backend/lambda/types
...
require (
	...
	github.com/seanrmurphy/ws-echo/backend/lambda/types v0.0.0-00010101000000-000000000000
